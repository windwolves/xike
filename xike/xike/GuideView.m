...
- (UIView *)viewForPage:(GuidePage *)page atXIndex:(CGFloat *)xIndex {
...
- (void)scrollViewDidEndDecelerating:(UIScrollView *)scrollView {
    ...
    if (self.currentPageIndex == (pageViews.count)) {
        if ([(id)self.delegate respondsToSelector:@selector(guideDidFinish)]) {
...
- (UIImage *)bgForPage:(int)idx {
    ...
    return ((GuidePage *)_pages[idx]).bgImage;
}
