...
@implementation CRJContactBubble
...
- (id)initWithName:(NSString *)name color:(CRJBubbleColor *)color selectedColor:(CRJBubbleColor *)selectedColor {
    self = [super init];
    if (self){
        self.name = name;
        self.isSelected = NO;
        ...
        if (color == nil){
            color = [[CRJBubbleColor alloc] initWithGradientTop:kBubbleColor gradientBottom:kBubbleColor border:kBubbleColor];
        }
        
        if (selectedColor == nil){
            selectedColor = [[CRJBubbleColor alloc] initWithGradientTop:kBubbleColorSelected gradientBottom:kBubbleColorSelected border:kBubbleColorSelected];
        }
