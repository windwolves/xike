...
@interface CRJContactPickerView (){
...
@property (nonatomic, strong) CRJBubbleColor *bubbleColor;
@property (nonatomic, strong) CRJBubbleColor *bubbleSelectedColor;

@end

@implementation CRJContactPickerView
...
- (void)setup {
    ...
    CRJContactBubble *contactBubble = [[CRJContactBubble alloc] initWithName:@"Sample"];
    ...
    self.layer.contents = (id)[UIImage imageNamed:@"search_picker.png"].CGImage;
...
- (void)addContact:(id)contact withName:(NSString *)name {
    ...
    CRJContactBubble *contactBubble = [[CRJContactBubble alloc] initWithName:name color:self.bubbleColor selectedColor:self.bubbleSelectedColor];
    if (self.font != nil){
...
- (void)removeAllContacts
{
    for(id contact in [self.contacts allKeys]){
        CRJContactBubble *contactBubble = [self.contacts objectForKey:contact];
...
- (void)removeContact:(id)contact {
    ...
    CRJContactBubble *contactBubble = [self.contacts objectForKey:contactKey];
    [contactBubble removeFromSuperview];
...
- (void)setBubbleColor:(CRJBubbleColor *)color selectedColor:(CRJBubbleColor *)selectedColor {
    ...
    for (id contactKey in self.contactKeys){
        CRJContactBubble *contactBubble = (CRJContactBubble *)[self.contacts objectForKey:contactKey];
...
- (void)removeContactBubble:(CRJContactBubble *)contactBubble {
...
- (id)contactForContactBubble:(CRJContactBubble *)contactBubble {
...
- (void)textViewDidBeginEditing:(UITextView *)textView {
    [self.delegate contactPickerTextViewDidBeginEditing];
}
...
#pragma mark - CRJContactBubbleDelegate Functions
